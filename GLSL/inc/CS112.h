...
* CS112.h                                                                  *
*                                                                          *
* This file defines a number of useful classes and functions that will be  *
* useful for CS112 students.  Loading this one header file will load all   *
* the other necessary headers, such "glut.h", "Vec3.h", and "Mat4x4.h".    *
*                                                                          *
* History:                                                                 *
*   10/07/2009  Created for CS112 students.                                *
*                                                                          *
***************************************************************************/
#ifndef __CS112_INCLUDED__
#define __CS112_INCLUDED__
